...
class MyBetsScreen extends StatelessWidget {
  const MyBetsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: Color(0xff122B48),
        body: Container(
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color: kBlueColor, //Color(0xff122B48),
        ...
        bottomNavigationBar: Container(
          ...
          height: 135.h,
          color: Color(0xff122B48), //kBlueColor,
          child: Column(
            children: [
              Row(
